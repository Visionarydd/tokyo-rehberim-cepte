...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Tokyo Türkçe Rehber" },
      { property: "og:title", content: "Tokyo Türkçe Rehber" },
      ...
      { name: "twitter:title", content: "Tokyo Türkçe Rehber" },
